...
AS $$
DECLARE
  project_url TEXT := 'https://aadytfqddjgmoorvjatv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhZHl0ZnFkZGpnbW9vcnZqYXR2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjEzMTE3NCwiZXhwIjoyMDIxNzA3MTc0fQ.3s1PM_ZFLpgBeH6W2ToBchHhEsPK6OQR52XO4kggXaQ'; -- full access needed for http request to storage
